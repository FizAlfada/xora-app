...
const Header = () => {
  return (
    <header className="fixed top-0 left-0 z-50 w-full py-10 bg-red-400">
      <div className="container flex h-14 items-center lg:px-4 bg-slate-500">
        <a href="#" className="lg:hidden flex-1 cursor-pointer p-2">
